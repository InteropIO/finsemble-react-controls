	...
	render() {
		...
		return (<div className={classes}>
			...
			<div className="form-group">
				<input autoFocus={this.props.autoFocus} type="text" maxLength={typeof this.props.maxLength !== 'undefined' ? this.props.maxLength : null} onChange={this.props.onInputChange} placeholder={this.props.placeholder? this.props.placeholder: ''} />
			</div>
			{this.props.children}
		</div>);
	}
